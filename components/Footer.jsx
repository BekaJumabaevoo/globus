      ...
      <footer className={s.content}>
        <div className={s.main_footer}>
          ...
          <div className={s.first_section}>
            ...
            <p className={s.footer_subtitle}>Сервис поиска работы в Европе от прямых работодателей</p>
            <p className={s.footer_question}>
            ...
            <div className={s.footer_list}>
              <li className={s.footer_list_item
                ...
                <a href="https://www.instagram.com/globusconsulting/"><Image src={instagram} alt="instgram" width={31} height={30}></Image></a>
              </li>
              <li className={s.footer_list_item
              }>
                <a href="https://web.telegram.org/z/#5469661933"><Image src={telegram} alt="telegram" width={31} height={30}></Image></a>
              </li>
            </div>
          </div>
          ...
          <div className={s.three_section}>
            ...
            <a href="globusconsulting@mail.ru"><b>globusconsulting@mail.ru</b></a>
            ...
            <div>
              <p>Бишкек</p>
              <p><a href=""><b>0700733366</b></a></p>
              <p><a href=""><b>0557713366</b></a></p>
              <p><a href=""><b>0777713366</b></a></p>
            </div>
            <div>
              <p>Ош</p>
              <p><a href=""><b>0703156066</b></a></p>
              <p><a href=""><b>0778256336</b></a></p>
            </div>
            <div>
              <p>Жалал-Абад</p>
              <p><a href=""><b>0556007284</b></a></p>
              <p><a href=""><b>0777085085</b></a></p>
            </div>
            <div>
              <p>Каракол</p>
              <p><a href=""><b>0709120621</b></a></p>
              <p><a href=""><b>0557713366</b></a></p>
            </div>
          </div>
            </div>
