  ...
  const leftAnimation = {
   ...
   return (
    ...
    viewport={{ amount: 0.3}}>
      ...
      <motion.div variants={leftAnimation} className={s.help_photo}  >
      </motion.div>
      ...
      <motion.div  variants={rightAnimation} className={s.help_desg}>
        ...
        <div className={s.items}>
          ...
          <p className={s.item}>На протяжении этого времени с нашей помощью работу нашли тысячи граждан Кыргызстана.</p>
        </div>
